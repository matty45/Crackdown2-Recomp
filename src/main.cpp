...
class Crackdown2App : public rex::ui::WindowedApp, public rex::ui::WindowListener {
public:
    static std::unique_ptr<rex::ui::WindowedApp> Create(rex::ui::WindowedAppContext& ctx) {
        return std::make_unique<Crackdown2App>(ctx);
    }

    Crackdown2App(rex::ui::WindowedAppContext& ctx)
        : WindowedApp(ctx, "crackdown2", "[game_directory]") {
    ...
    bool OnInitialize() override {
        ...
        REXLOG_INFO("crackdown2 starting");
        ...
        // Create window
        window_ = rex::ui::Window::Create(app_context(), "crackdown2", 1280, 720);
        if (!window_) {
...
XE_DEFINE_WINDOWED_APP(crackdown2, Crackdown2App::Create)
